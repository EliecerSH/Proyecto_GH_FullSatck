...
const exercises = {
  ...
  irregularVerbs: {
    ...
    data: [
      ...
      { base: "know", past: "knew", participle: "known", spanish: "conocer/saber" }
    ]
  },
  ...
  tenses: {
    ...
    data: [
      ...
      { tense: "present", pronoun: "She", verb: "read", answer: "reads", spanish: "ella lee" },
      { tense: "present", pronoun: "They", verb: "run", answer: "run", spanish: "ellos corren" },
      { tense: "present", pronoun: "He", verb: "play", answer: "plays", spanish: "él juega" },
      { tense: "present", pronoun: "You", verb: "work", answer: "work", spanish: "tú trabajas" },
      ...
      { tense: "past", pronoun: "He", verb: "read", answer: "read", spanish: "él leyó" },
      { tense: "past", pronoun: "We", verb: "write", answer: "wrote", spanish: "nosotros escribimos" },
      { tense: "past", pronoun: "You", verb: "have", answer: "had", spanish: "tú tuviste" },
      ...
      { tense: "future", pronoun: "I", verb: "play", answer: "will play", spanish: "yo jugaré" },
      { tense: "future", pronoun: "They", verb: "visit", answer: "will visit", spanish: "ellos visitarán" },
      { tense: "future", pronoun: "He", verb: "cook", answer: "will cook", spanish: "él cocinará" },
      ...
      { tense: "present", pronoun: "We", verb: "study", answer: "are studying", spanish: "nosotros estamos estudiando" },
      { tense: "present", pronoun: "They", verb: "play", answer: "are playing", spanish: "ellos están jugando" },

      // Pasado continuo
      { tense: "past", pronoun: "They", verb: "sleep", answer: "were sleeping", spanish: "ellos estaban durmiendo" },
      { tense: "past", pronoun: "She", verb: "read", answer: "was reading", spanish: "ella estaba leyendo" },
      { tense: "past", pronoun: "I", verb: "write", answer: "was writing", spanish: "yo estaba escribiendo" }
    ]
  }
};
